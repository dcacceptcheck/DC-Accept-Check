...
function updateProductSelectColor() {
  if (els.productFilter.value) {
    els.productFilter.classList.remove("placeholder-select");
    els.productFilter.classList.add("selected-select");
  } else {
    els.productFilter.classList.remove("selected-select");
    els.productFilter.classList.add("placeholder-select");
  }
}
